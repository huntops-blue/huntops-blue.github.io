...
## Detection Logic
[--not started--Additional analysis, modeling, and signatures (KQL and Yara)](https://github.com/huntops-blue/detection-logic/blob/master/trickbot.md).

`[A-Za-z]{2}-[0-9]{12}_[0-9]{4}.zip` <- this is for SE-670131329809_5500[.]zip, add this to detection logic.
